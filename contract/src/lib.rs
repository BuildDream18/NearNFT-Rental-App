...
impl Contract {
    ...
    fn activate_lease(&mut self, lease_id: LeaseId) {
        ...
        env::log_str(
            &json!({
                "type": "[INFO] RentApp Rental: A lease has been activated",
                "params": {
    ...
    fn internal_insert_lease(&mut self, lease_id: &LeaseId, lease_condition: &LeaseCondition) {
        ...
        env::log_str(
            &json!({
                "type": "[INFO] RentApp Rental: A new lease has been inserted.",
                "params": {
                    "lease_id": lease_id.clone(),
...
impl NonFungibleTokenTransferReceiver for Contract {
    ...
    fn nft_on_transfer(
        ...
        env::log_str(
            &json!({
                "type": "[DEBUG] RentApp Rental: Creating a lease for the received NFT.",
                "params": {
