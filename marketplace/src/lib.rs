...
impl Contract {
    ...
    pub fn transfer_rent_after_nft_transfer(
        ...
        env::log_str(
            &json!({
                "type": "[INFO] RentApp Marketplace: transfer rent",
                "params": {
                    "nft_contract_id": listing.nft_contract_id.clone(),
                    "nft_token_id": listing.nft_token_id.clone(),
    ...
    pub fn create_listing_with_payout(
        ...
        env::log_str(
            &json!({
                "type": "[DEBUG] RentApp Marketplace: Create a listing for the leasing NFT.",
                "params": {
    ...
    fn internal_remove_listing(&mut self, listing_id: ListingId) {
        ...
        env::log_str(
            &json!({
                "type": "[INFO] RentApp Marketplace: remove listing",
                "params": {
